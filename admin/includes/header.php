...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="live_monitor"><i class="fas fa-video"></i> Live Monitor <span class="badge bg-danger ms-1" style="font-size: 10px;">LIVE</span></a></li>
            <li><a href="employees"><i class="fas fa-users"></i> Manage Employees</a></li>
            <li><a href="#" data-bs-toggle="collapse" data-bs-target="#reportsMenu"><i class="fas fa-chart-bar"></i> Reports <i class="fas fa-chevron-down float-end"></i></a>
                <ul class="collapse list-unstyled ps-4" id="reportsMenu">
                    <li><a href="user_tracking"><i class="fas fa-user-clock"></i> User Tracking</a></li>
                    <li><a href="application_usage"><i class="fas fa-desktop"></i> Application Usage</a></li>
                    <li><a href="screenshot_report"><i class="fas fa-camera"></i> Screenshots</a></li>
                    <li><a href="daily_attendance"><i class="fas fa-calendar-check"></i> Daily Attendance</a></li>
                    <li><a href="idle_time_analysis"><i class="fas fa-clock"></i> Idle Time Analysis</a></li>
                </ul>
            </li>
